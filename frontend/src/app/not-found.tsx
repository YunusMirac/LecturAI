...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#fafafa] px-4 dark:bg-zinc-950">
      <p className="text-sm font-semibold uppercase tracking-widest text-[#777777] dark:text-zinc-400">
        404
      </p>
      <h1 className="mt-2 text-3xl font-extrabold text-[#333333] dark:text-zinc-100">
        Seite nicht verfügbar
      </h1>
      <p className="mt-3 max-w-md text-center text-[#666666] dark:text-zinc-400">
