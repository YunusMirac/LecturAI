...
import { fetchLivePlayState, submitLiveAnswer } from "@/lib/api/quizLiveApi";
...
export default function QuizPlayPageClient() {
  ...
  const qNum = state ? state.current_question_index + 1 : 0;
          ...
          {state ? (
            <>
              <div className="mb-5 flex items-center justify-between gap-3">
                <h1 className="truncate text-lg font-bold text-[#333333] dark:text-zinc-100">
                  {state.title}
                </h1>
